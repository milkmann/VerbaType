...
public class APISettingsActivity extends AppCompatActivity {
    ...
    private EditText transcriptionCustomPromptEt;
    ...
    private String transcriptionCustomPrompt;

    public static final String DEFAULT_CUSTOM_TRANSCRIPTION_PROMPT = 
    ...
    private String transcriptionAPIKeyCustomMultimodal;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        transcriptionCustomPromptEt = findViewById(R.id.api_settings_transcription_custom_prompt_et);
        ...
        transcriptionCustomPrompt = sp.getString("net.devemperor.dictate.transcription_custom_prompt", DEFAULT_CUSTOM_TRANSCRIPTION_PROMPT);
        transcriptionCustomPromptEt.setText(transcriptionCustomPrompt);
        transcriptionCustomPromptEt.addTextChangedListener(new SimpleTextWatcher() {
            @Override
            public void afterTextChanged(Editable editable) {
                sp.edit().putString("net.devemperor.dictate.transcription_custom_prompt", editable.toString()).apply();
            }
        });

        disableRewordingForMultimodalSwitch = findViewById(R.id.api_settings_transcription_disable_rewording_switch);
        disableRewordingForMultimodal = sp.getBoolean("net.devemperor.dictate.disable_rewording_for_multimodal", false);
        disableRewordingForMultimodalSwitch.setChecked(disableRewordingForMultimodal);
        disableRewordingForMultimodalSwitch.setOnCheckedChangeListener((buttonView, isChecked) -> {
            sp.edit().putBoolean("net.devemperor.dictate.disable_rewording_for_multimodal", isChecked).apply();
            disableRewordingForMultimodal = isChecked;
        });
        ...
        transcriptionAPIKeyCustomMultimodal = sp.getString("net.devemperor.dictate.transcription_api_key_custom_multimodal", transcriptionProvider == 3 ? oldTranscriptionKey : "");
        ...
        transcriptionAPIKeyEt.addTextChangedListener(new SimpleTextWatcher() {
            ...
            public void afterTextChanged(Editable editable) {
                ...
                if (transcriptionProvider == 0) {
                    ...
                    transcriptionAPIKeyCustomMultimodal = newKey;
                    sp.edit().putString("net.devemperor.dictate.transcription_api_key_custom_multimodal", newKey).apply();
                }
            }
        });
    ...
    private void updateTranscriptionModels(int position) {
        ...
        if (position == 0) {
            ...
            transcriptionAPIKeyEt.setText(transcriptionAPIKeyCustomMultimodal);
        }
