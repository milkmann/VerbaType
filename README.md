...
VoxScribe is an easy-to-use Android IME keyboard for transcribing and dictating speech. It supports extremely accurate results for many different languages, with custom multimodal transcription endpoints (e.g. Google Gemini 3 Flash / 2.5 Flash), punctuation formatting, and background AI rewording.
...
## License
VoxScribe is licensed under the [Apache 2.0 License](LICENSE). 
